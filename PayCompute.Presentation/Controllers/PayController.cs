...
namespace PayCompute.Controllers
{
    ...
    public class PayController : Controller
    {
        ...
        private readonly INationalInsuranceContributionService _nationalInsurance;
        ...
        public PayController(IPayComputationService payComputationService,
                             ...
                             ITaxService tax,
                             INationalInsuranceContributionService nationalInsurance) 
        {
        ...
        public async Task<IActionResult> Create(PaymentRecordCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var payrecord = new PaymentRecord()
                {
                    ...
                    Tax = tax = _tax.TaxAmount(totalEarnings),
                    ...
                    NIC = nationalInsurance = _nationalInsurance.NIContribution(totalEarnings),
